...
public class AddItUpActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRightAnsSound = mSoundPool.load(AddItUpActivity.this, R.raw.rightanswer, 1);
        mWrongAnsSound = mSoundPool.load(AddItUpActivity.this, R.raw.wronganswer, 1);
    ...
    private void displayToast(String strMessage) {
        Toast toast;
        toast = Toast.makeText(AddItUpActivity.this, strMessage, Toast.LENGTH_SHORT);
